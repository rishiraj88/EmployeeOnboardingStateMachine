    ...
    private StateMachineListener<EmployeeState, EmployeeEvent> listener() {
        return new StateMachineListenerAdapter<>() {
            ...
            public void stateChanged(State<EmployeeState, EmployeeEvent> from, State<EmployeeState, EmployeeEvent> to) {
                try {
                    log.info("stateChanged from " + from.getId() + " to " + to.getId());
                } catch (Exception e) {
            ...
            public void transitionStarted(Transition<EmployeeState, EmployeeEvent> transition) {
                ...
                try {
                    ...
                    log.info("Exception in transitionStarted");
    ...
    public Action<EmployeeState, EmployeeEvent> startBothChecks() {
        return new Action<>() {
            ...
            public void execute(StateContext<EmployeeState, EmployeeEvent> context) {
                ...
                context.getExtendedState().getVariables().put("security check state", "started");
                System.out.println("Setting InitialWorkPermitCheck to 'started'");
                context.getExtendedState().getVariables().put("work permit check state", "started");
            }
        };
    }
...
//                return true;
                ...
                return "started".equals(context.getExtendedState().getVariables().get("work permit check state"));
            }
        };
    }
...
//                return true;
                ...
                return "started".equals(context.getExtendedState().getVariables().get("security check state"));
            }
        };
    }
...
//                return true;
                ...
                return "pending".equals(context.getExtendedState().getVariables().get("work permit check state"));
            }
        };
    }
    @Bean // while
...
//                return true;
                ...
                return "done".equals(context.getExtendedState().getVariables().get("security check state")) && "done".equals(context.getExtendedState().getVariables().get("work permit check state"));
            }
        };
    }
    ...
    public Action<EmployeeState, EmployeeEvent> finishSecurityCheck() {
        return new Action<>() {
            ...
            public void execute(StateContext<EmployeeState, EmployeeEvent> context) {
                ...
                context.getExtendedState().getVariables().put("security check state", "done");
            }
        };
    }
    ...
    public Action<EmployeeState, EmployeeEvent> completeInitialWorkPermitCheck() {
        return new Action<>() {
            ...
            public void execute(StateContext<EmployeeState, EmployeeEvent> context) {
                ...
                context.getExtendedState().getVariables().put("work permit check state", "pending");
            }
        };
    }
    ...
    public Action<EmployeeState, EmployeeEvent> finishWorkPermitCheck() {
        return new Action<>() {
            ...
            public void execute(StateContext<EmployeeState, EmployeeEvent> context) {
                ...
                context.getExtendedState().getVariables().put("work permit check state", "done");
            }
        };
    }
}